...
import RobotCalibrationConfiguration from './assets/robot-calibration-configuration.png' import RobotCameraCalibration
from './assets/robot-camera-calibration-component.png' import URCalibrationFile from './assets/UR-calibration-file.png'
import FrameBroadcasterExpectedFileFormat from './assets/frame-broadcaster-expected-file-format.png' import
FrameBroadcasterPublishManually from './assets/frame-broadcaster-publish-manually.png' import
FrameBroadcasterDirectFilepath from './assets/frame-broadcaster-direct-filepath.png'
