...
<div style={{display: 'flex', justifyContent: 'center', paddingBottom: '1rem'}}>
    <img src={CodeView} alt="aica-studio-code-view" width="600" style={{ borderRadius: "8px" }}/>
</div>
...
<div style={{display: 'flex', justifyContent: 'center', paddingBottom: '1rem'}}>
    <img src={LogsView} alt="aica-studio-logs-view" width="600" style={{ borderRadius: "8px" }}/>
</div>
...
<div style={{display: 'flex', justifyContent: 'center', paddingBottom: '1rem'}}>
    <img src={StateTableView} alt="aica-studio-state-table-view" width="600" style={{ borderRadius: "8px" }}/>
</div>