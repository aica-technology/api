...
The right panel of the System application editor is an interactive window into configuring and monitoring all aspects of
a System application. It has different functionality depending on the currently selected elements and the contents or
...
The Code view shows the YAML code representation of the System application. This code is automatically regenerated
