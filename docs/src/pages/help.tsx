    ...
    return (
        <Layout>
            <div className="container margin-vert--lg">
                ...
                <p className="">
                    Find helpful links to tutorials, community pages, and support options. Everything you need to go
                    further with the Adaptive & Intelligent Control System.
                </p>
                ...
                <ResourceItem
                    ...
                    image={aicademy}
                    alt="AI Academy preview"
                />

                <ResourceItem
                    title="Community"
                    description="Engage with the Community to discover planned features and improvements, submit your feedback, and propose your own ideas."
                ...
                <ResourceItem
                    ...
                    description="Use support credits to access online or onsite support and training. Contact us: support@ai-can-change.tech"
                    href="https://link.aica.tech/contact-support"
                    image={poweredAica}
                    alt="Powered by Studio"
                />
