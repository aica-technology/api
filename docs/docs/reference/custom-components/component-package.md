...
Custom components can be defined in ROS 2 packages and used alongside the standard library of AICA components in Core. Components can be implemented in C++ or Python. A component package can contain multiple
