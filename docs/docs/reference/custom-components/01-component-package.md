...
The creation of a component package can be greatly simplified by using our [Component Template](https://github.com/aica-technology/component-template). It comes with a boilerplate project which support both C++ and Python.
