...
The [YAML application schema](https://docs.aica.tech/schemas/1-0-1/application.schema.json) defines the structural rules
...
```yaml
# yaml-language-server: $schema=https://docs.aica.tech/schemas/1-0-1/application.schema.json
```
