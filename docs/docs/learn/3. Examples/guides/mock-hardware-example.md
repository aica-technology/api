...
Refer to the overview section [Controlling robots with ros2_control](../../concepts/ros-concepts/controlling-robots) for
more context.
...
the [YAML application syntax](../../reference/yaml-syntax) reference page.
