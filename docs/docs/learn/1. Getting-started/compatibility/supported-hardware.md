...
As described in [this section](../../concepts/ros-concepts/built-on-ros), the AICA System can integrate existing ROS
...
|--------------|-----------------------------|---------|------------------|
| [ABB](../../examples/guides/abb-hardware-interface) | OmniCore | Robot Web Services, Externally Guided Motion | RobotWare 7.X |
...
| [Universal Robots](../../examples/guides/ur-harware-interface) | Polyscope > 5.X | n/a | |
...
| [Orbbec](../../examples/guides/orbbec-component) | Gemini 33X/435Le/2/2L, Femto Bolt/Mega, Astra 2  | n/a | |
| [Intel RealSense](../../examples/guides/realsense-component) |  L515, D4XX | n/a | |
