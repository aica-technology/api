...
Core [here](../../reference/manual-installation-launch). It is **recommended** that you skip the installation of
...
configuration (see
[manual installation](../../reference/manual-installation-launch#configuring-docker-manually-on-linux-macos-or-windows)
for more details).
...
[these](../../reference/manual-installation-launch#configuring-docker-manually-on-linux-macos-or-windows) additional
...
[manually install and run the AICA System on Windows](../../reference/manual-installation-launch#configuring-docker-manually-on-linux-macos-or-windows).
...
be performed [manually from the command line](../../reference/manual-installation-launch) instead of using AICA
Launcher.