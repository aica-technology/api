...
[This guide](../../examples/guides/application-frames) contains an in-depth review of methods to create, edit, and
...
See [this page](../../examples/core-components/point-attractor) for an example that uses the Frame to Signal
