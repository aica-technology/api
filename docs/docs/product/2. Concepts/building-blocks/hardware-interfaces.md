...
responsible for exposing the robot's state and accepting control commands generated by controllers that need to be
...
AICA Core supports hardware interfaces for **all major robot manipulator brands** and a range of simulators. It is also
