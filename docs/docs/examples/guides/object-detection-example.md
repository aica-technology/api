...
### Creating a custom component to generate twist to keep a bounding box centered
...
you should see `Object detection utils` package listed in the `Add Component` menu, as well as a `BoundingBoxTracker`
