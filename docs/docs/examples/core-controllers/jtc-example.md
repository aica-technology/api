...
frame.
3. Starting AICA Core v4.4.2, you can alternatively provide `durations` instead of `times_from_start`, that is, you can
provide a list of absolute durations for each waypoint.
