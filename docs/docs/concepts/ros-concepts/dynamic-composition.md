...
processes. <nobr>ROS 2</nobr> **components** and **lifecycle components** are an extension to nodes that are compiled as shared libraries. Rather than being launched directly, components are dynamically loaded by other processes.
